...
* [`Streams API`][streams]（流处理）允许应用程序作为流处理器，消费从一个或多个`topics`中获取的输入流并生产输出流到一个或多个`topics`中，有效地进行输入流和输出流的转换
...
[producer]: ../apis/producer-api.md
[consumer]: ../apis/consumer-api.md
[streams]: ../apis/streams-api.md
